      ...
      <Fade in={isVisible} transition={{ enter: { duration: 1 } }}>
        <Box>
          ...
          <Flex className="skillyexp-content" justify="center" flexWrap="wrap" gap={{ base: 4, md: 6 }}>
            <Box className="skills" flex="1" maxW={{ base: "full", md: "45%" }} m={4} mt={{ base: 8, md: 0 }}> 
              ...
              <SimpleGrid columns={{ base: 2, sm: 3, md: 3 }} spacing={{ base: 4, md: 6 }} justifyContent="center">
                {skills.map((skill, index) => (
                  <Box key={index} className="skill-item" mt={index === 0 ? "18px" : "12px"} p={6} borderRadius="md" transition="transform 0.3s, background-color 0.3s" mx="auto" _hover={{ transform: 'translateY(-10px)', bg: 'gray.800' }} boxShadow="md" border="2px solid" borderColor="white">
            ...
            <Box className="experience" flex="1" maxW={{ base: "full", md: "45%" }} m={4} mt={{ base: 8, md: 0 }}> 
